...
*/
    ...
    componentDidMount() {
                ...
                const sensorData = this.MiTemperatura.temperatura;
        ...
        return (
            <div>
                ...
                <div style={miestilo}>
                    ...
                    <Temperature height="225" value={this.state.chartData/2}/>
                    {/*<Humidity value={this.state.chartData}/>*/}
                    <Electricity height="175" value={this.state.chartData}/>
                    <Tvoc height="175" value={this.state.chartData/100}/>
